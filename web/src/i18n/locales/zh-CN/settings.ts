const settings = {
  ...
  'settings.model.providerCustom': '自定义',
  'settings.model.fetchModels': '拉取模型',
  'settings.model.fetching': '拉取中...',
  'settings.model.selectModel': '选择模型',
  'settings.model.saveProfile': '保存此模型',
  'settings.model.saveSuccess': '配置已保存，全局生效',
  'settings.model.saveError': '配置保存失败',
  'settings.model.searchModels': '搜索模型...',
  'settings.model.noModelsFound': '未找到匹配的模型',
